...
granularity="packet"
sameple_nums=(100 5000 8000)
dataset_names=("qq" "weixin")
sampling_methods=("average_sampling" "sequential_sampling")
...
for dataset_name in ${dataset_names[@]}; do
    for sampling_method in ${sampling_methods[@]}; do
        for sameple_num in ${sameple_nums[@]}; do
            ...
            nohup python preprocess_dataset.py --input ~/changc/traffic/${dataset_name} \
